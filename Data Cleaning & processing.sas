...
/* Repeat for MRP_12 */
proc logistic data=missing_check desc;
    model miss_MRP_12 = age sex Conditions Total_Meds Presc_Meds Health_Utilization death Undertreat_0 Sub_dose_0 Med_Mon_0 Sub_drug_0 AE_0 NonAd_0 ; 
/*     oddsratio age / at (age=5);   */
/*     oddsratio treatment;       */
...
proc logistic data=missing_check desc;
    model miss_MRP_6 = age sex Conditions Total_Meds Presc_Meds Health_Utilization; 
/*     oddsratio age / at (age=5);  */
/*     oddsratio treatment;      */
    title "MAR Check: MRP_6 Missingness vs. Observed Variables (with ORs)";
    ods output ParameterEstimates=MAR_MRP_6;
...
/* Repeat for MRP_12 */
proc logistic data=missing_check desc;
    model miss_MRP_12 = age sex Conditions Total_Meds Presc_Meds Health_Utilization; 
/*     oddsratio age / at (age=5);   */
/*     oddsratio treatment;       */
    title "MAR Check: MRP_12 Missingness vs. Observed Variables (with ORs)";
    ods output ParameterEstimates=MAR_MRP_12;
...
/***********************************
Export Data for primary analysis
************************************/
